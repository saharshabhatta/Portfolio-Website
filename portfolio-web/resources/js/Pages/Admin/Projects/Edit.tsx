...
export default function ProjectEdit({ project }: ProjectEditProps) {
    ...
    return (
        <AdminLayout
            ...
            subtitle="Update project details, links, tags, and media."
            actions={
                <Link
                    href="/admin/projects"
                ...
                <div className="rounded-2xl border border-slate-200/80 bg-white/70 p-6 shadow-sm backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-900/50 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="flex gap-2 mb-3">
                            <input
                                ...
                                placeholder="e.g. Dynamic Content Delivery"
                                className="flex-1 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs text-slate-900 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                            />
                            <button
                                type="button"
                        ...
                        <div>
                            ...
                            <div className="mt-3">
                                <label className="flex items-center gap-2 text-xs font-semibold text-slate-500 hover:text-blue-600 cursor-pointer">
                                    ...
                                    <span>Upload replace image file</span>
                                    <input
                                        type="file"
                                        accept="image/*"
                                        className="hidden"
                    ...
                    <div className="flex flex-wrap items-center gap-6 pt-4 border-t border-slate-100 dark:border-slate-800">
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <label htmlFor="is_published_edit" className="text-sm font-semibold text-slate-800 dark:text-slate-200 cursor-pointer">
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                ...
                                className="h-4 w-4 rounded border-slate-300 text-blue-600"
                            />
                            <label htmlFor="is_featured_edit" className="text-sm font-semibold text-slate-800 dark:text-slate-200 cursor-pointer">
                                Featured project
                            </label>
                        </div>
                    </div>

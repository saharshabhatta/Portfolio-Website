...
export default function ExperienceCreate() {
    ...
    return (
        <AdminLayout
            ...
            subtitle="Record a new role, internship, or company achievement."
            actions={
                <Link
            ...
            <form onSubmit={submit} className="space-y-8 max-w-4xl">
                <div className="rounded-2xl border border-slate-200/80 bg-white/70 p-6 shadow-sm backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-900/50 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                                placeholder="e.g. Professional Experience or Acme Inc."
                                required
                            />
                            {errors.company && (
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                            placeholder="Detail your responsibilities, technologies utilized, and impact..."
                            required
                        />
                    </div>
                    ...
                    <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <label htmlFor="is_published_exp" className="text-sm font-semibold text-slate-800 dark:text-slate-200 cursor-pointer">
                                Publish on website timeline
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-end gap-3">
                    ...
                    >
                        ...
                        <span>{processing ? 'Saving...' : 'Create Experience'}</span>
                    </button>
                </div>
            </form>
        </AdminLayout>
